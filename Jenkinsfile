pipeline {
    ...
    steps {
        script {
            ...
            echo "aws_access_key_id=AKIARBJK26MF7IOOW6X2" >> /var/lib/jenkins/.aws/credentials
            echo "aws_secret_access_key=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" >> /var/lib/jenkins/.aws/credentials
